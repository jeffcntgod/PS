...
$DeclineLastLevelOnly & $trial CANNOT be used at the same time.
	...
	Version:	
	Author:		Jeff Carreon
    Updates: ver. 5.4.5  (8/30/2023)
        - Cosmetic fixes
		- WARNING: Please read the default settings below, prior to implementing this in your production enviroment. 
		- TEST TEST TEST TEST!
...
.DESCRIPTION 
 Script is designed to decline updates that have been superseded for over 90 days (by default), and MORE!. 
...
Param(
	...
	[string] $CMprovider = "YOURPROVIDERSERVER",

	[string] $SiteCode = "XXX",

    [string] $SUSDBServer = "SUSDBSERVER",
	...
	[string]$SMTPServer = "SMTP.yourlab.com",
	
	[string]$From = "GROUP@yourlab.com",
	
	[string[]]$To = "bob@yourlab.com,bob2@yourlab.com,bob3@yourlab.com",
...
if($kb){$SinglePatch = $kb}
Else {$SinglePatch = $UpdateID}
...
Function DeclineSuperseded
{
	#Write-ToLog ""
    
    Write-ToLog ""
    Write-ToLog "$script:WsusServer is starting DeclineSupersededUpdates function..."
...
Function DeclineItanium{


	Write-ToLog "$script:WsusServer is starting DeclineWsusItaniumUpdates function..... Please wait...."
...
Function DeclineXPUpdates{



	Write-ToLog "$script:WsusServer is starting DeclineXPUpdates function..... Please wait...."
    #Write-ToLog "Connecting to $script:WsusServer..."
...
Function DeclinePreview{
	...
	Write-ToLog "$script:WsusServer is starting DeclinePreview function..... Please wait...."
...
Function DeclineBeta{
	...
	Write-ToLog "$script:WsusServer is starting DeclineBeta function..... Please wait...."
...
Function DeclineWin10Next{
	
	Write-ToLog "$script:WsusServer is starting DeclineWin10Next function..... Please wait...."
...
Function DeclineServerNext{
	$Script:ServerNextcount = 0
	Write-ToLog "$script:WsusServer is starting DeclineServerNext function..... Please wait...."
...
Function DeclineIE7{
	...
	Write-ToLog "$script:WsusServer is starting DeclineIE7 function..... Please wait...."
...
Function DeclineIE8{
	...
	Write-ToLog "$script:WsusServer is starting DeclineIE8 function..... Please wait...."
...
Function DeclineIE9{
	...
	Write-ToLog "$script:WsusServer is starting DeclineIE9 function..... Please wait...."
...
Function DeclineEmbedded{

	Write-ToLog "$script:WsusServer is starting DeclineEmbedded function..... Please wait...."
...
Function DeclineARM64{

	Write-ToLog "$script:WsusServer is starting DeclineARM64 function..... Please wait...."
...
Function DeclineIE10{

	Write-ToLog "$script:WsusServer is starting DeclineIE10 function..... Please wait...."
...
Function DeclineWin7{

	Write-ToLog "$script:WsusServer is starting DeclineWin7 function..... Please wait...."
...
Function DeclineWin8{

	Write-ToLog "$script:WsusServer is starting DeclineWin8 function..... Please wait...."
...
Function DeclineWin81{

	Write-ToLog "$script:WsusServer is starting DeclineWin81 function..... Please wait...."
...
Function DeclineWin2k3{

	Write-ToLog "$script:WsusServer is starting DeclineWin2k3 function..... Please wait...."
...
Function DeclineWin2k8{

	Write-ToLog "$script:WsusServer is starting DeclineWin2k8 function..... Please wait...."
...
Function DeclineWin2k8R2{

	Write-ToLog "$script:WsusServer is starting DeclineWin2k8R2 function..... Please wait...."
...
Function DeclineWin12{

	Write-ToLog "$script:WsusServer is starting DeclineWin12 function..... Please wait...."
...
Function DeclineWin12R2{

	Write-ToLog "$script:WsusServer is starting DeclineWin12R2function..... Please wait...."
...
Function DeclineLegacyWin10{

	Write-ToLog "$script:WsusServer is starting DeclineLegacyWin10 function..... Please wait...."
...
Function DeclineLegacyOff365{

	Write-ToLog "$script:WsusServer is starting DeclineLegacyOff365 function..... Please wait...."
...
Function DeclineWin10FeatureUpdates{

	Write-ToLog "$script:WsusServer is starting DeclineWin10FeatureUpdates function..... Please wait...."
...
Function DeclineOneOff{
    ...
    ############################### Modify below for Manual###################

	if($script:KB){$script:OneOff=$GrabUpdates | where-object {$_.Title -like $SinglePatch}}
    Else{$script:OneOff=$GrabUpdates | where-object {$_.id.UpdateId -eq $UpdateID}}
	...
	If($script:OneOff)
	{
	    ...
	    Try
	    {
		    ...
		    $Table = @{Name="Title";Expression={[string]$_.Title}},`
                ...
                @{Name="UpdateID";Expression={[string]$_.id.UpdateId.Guid}},`
			    @{Name="KB Article";Expression={[string]$_.KnowledgebaseArticles}},`
			    @{Name="Arrival Date";Expression={[string]$_.ArrivalDate}},`
                @{Name="Classification";Expression={[string]$_.UpdateClassificationTitle}},`
			    @{Name="Product Title";Expression={[string]$_.ProductTitles}},`
...
Function WSUSCleanupCompressUpdates{
...
Function WSUSCleanupCleanupObsComputers{
...
Function WSUSCleanupUneededContentFiles{
...
$jeffobjects = Foreach ($script:WsusServer in $servers)
{
	...
	Try{DeclineSuperseded{};$Props."All Superseded" = ("$script:countSupersededAll");$Props."Superseded > $ExclusionPeriod" = ("$script:countSupersededExclusionPeriod")}
	Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineSuperseded UpdatesWithExclusionPeriod function on $script:WsusServer" -Source $EventSource -EntryType Error;	SendMail{}}
		
    Write-ToLog "DeclineSuperseded Updates function.....  Done."
	Write-ToLog ""
	...
	If ($OneOffCleanup)
	{	
		Try{DeclineOneOff{};$Props."OneOff" = ("$Script:OneOffcount")}
		Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineOneOff function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	}
	Else
	{ 
		    ...
		    If (!$SkipItanium)
	    {
		    ...
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWsusItaniumUpdates function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
        Else
            { 
                Write-ToLog "SkipItanium is set to $SkipItanium.  Skipping DeclineWSusItaniumUpdates Function."
                $its = "Skipped"
	    ...
	    If (!$SkipXP)
	    {	
		    Try{DeclineXPUpdates{}}#;$Props."Windows XP" = ($Script:XPcount)}
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineXPUpdates function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    {
		    Write-ToLog "SkipXP is set to $SkipXP.  Skipping DeclineXPUpdates Function."
		    $xps = "Skipped"
	    ...
	    {	
		    ...
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin7 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin7 is set to $SkipWin7.  Skipping DeclineWin7 Function."
		    $wn7= "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin8{};if($Script:Win8count -ne '0'){ $Props."Win 8" = ($Script:Win8count) } else { $script:zerovals.Add('Win 8') > $null}
			    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin8 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin8 is set to $SkipWin8.  Skipping DeclineWin8 Function."
		    $wn8 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin81{};if($Script:Win81count -ne '0'){$Props."Win 8.1" = ($Script:Win81count)} else { $script:zerovals.Add('Win 8.1') > $null}
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin81 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin81 is set to $SkipWin81.  Skipping DeclineWin81 Function."
		    $w81 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineEmbedded{};if($Script:Embeddedcount -ne '0'){$Props."Embedded" = ($Script:Embeddedcount)} else { $script:zerovals.Add('Embedded') > $null} 
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineEmbedded function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipEmbedded is set to $SkipEmbedded.  Skipping DeclineEmbedded Function."
		    $ems = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin2k3{};if($Script:Win2k3count -ne '0'){$Props."Server 03" = ($Script:Win2k3count)} else { $script:zerovals.Add('Win 2k3') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin2k3 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin2k3 is set to $SkipWin2k3.  Skipping DeclineWin2k3 Function."
		    $wk3 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin2k8{};if($Script:Win2k8count -ne '0'){$Props."Server 08" = ($Script:Win2k8count)} else { $script:zerovals.Add('Win 2k8') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin2k8 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin2k8 is set to $SkipWin2k8.  Skipping DeclineWin2k8 Function."
		    $wk8 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin2k8R2{};if($Script:Win2k8R2count -ne '0'){$Props."Server 08 R2" = ($Script:Win2k8R2count)} else { $script:zerovals.Add('Win 2k8R2') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin2k8R2 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin2k8R2 is set to $SkipWin2k8R2.  Skipping DeclineWin2k8R2 Function."
		    $wk8r2 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin12{};if($Script:Win12count -ne '0'){$Props."Server 12" = ($Script:Win12count)} else { $script:zerovals.Add('Win 12') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin12 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin12 is set to $SkipWin12.  Skipping DeclineWin12 Function."
		    $w12 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin12R2{};if($Script:Win12R2count -ne '0'){$Props."Server 12R2" = ($Script:Win12R2count)} else { $script:zerovals.Add('Win 12R2') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin12R2 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin12R2 is set to $SkipWin12R2.  Skipping DeclineWin12R2 Function."
		    $w12r2 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclinePreview{};if($script:Prevcount -ne '0'){$Props."Previews" = ("$script:Prevcount")} else { $script:zerovals.Add('Previews') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclinePreview function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipPrev is set to $SkipPrev.  Skipping DeclinePreview Function."
		    $pvs = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineBeta{};if($Script:Betacount -ne '0'){$Props."Beta" = ("$Script:Betacount")} else { $script:zerovals.Add('Beta') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineBeta function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipBeta is set to $SkipBeta.  Skipping DeclineBeta Function."
		    $bts = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineServerNext{};if($script:ServerNextcount -ne '0'){$Props."Server Next" = ($script:ServerNextcount)} else { $script:zerovals.Add('Server Next') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineServerNext function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipServerNext is set to $SkipServerNext.  Skipping DeclineServerNext Function."
		    $sns = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineIE7{};if($Script:IE7count -ne '0'){$Props."IE 7" = ($Script:IE7count)} else { $script:zerovals.Add('IE7') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineIE7 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
        Else
            { 
                Write-ToLog "SkipIE7 is set to $SkipIE7.  Skipping DeclineIE7 Function."
                $i7s = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineIE8{};if($Script:IE8count -ne '0'){$Props."IE 8" = ($Script:IE8count)} else { $script:zerovals.Add('IE8') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineIE8 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
        Else
            { 
                Write-ToLog "SkipIE8 is set to $SkipIE8.  Skipping DeclineIE8 Function."
                $i8s = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineIE9{};if($Script:IE9count -ne '0'){$Props."IE 9" = ($Script:IE9count)} else { $script:zerovals.Add('IE9') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineIE9 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipIE9 is set to $SkipIE9.  Skipping DeclineIE9 Function."
		    $i9s = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineIE10{};if($Script:IE10count -ne '0'){$Props."IE 10" = ($Script:IE10count)} else { $script:zerovals.Add('IE10') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineIE10 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipIE10 is set to $SkipIE10.  Skipping DeclineIE10 Function."
		    $i0s = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineARM64{};if($Script:Arm64count -ne '0'){$Props."ARM64" = ($Script:Arm64count)} else { $script:zerovals.Add('ARM64') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineARM64 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipArm64 is set to $SkipArm64.  Skipping DeclineARM64 Function."
		    $arm = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin10Next{};if($Script:Win10Nextcount -ne '0'){$Props."Win10 Next" = ("$Script:Win10Nextcount")} else { $script:zerovals.Add('Win10 Next') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin10Next function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin10Next is set to $SkipWin10Next.  Skipping DeclineWin10Next Function."
		    $wns = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineLegacyWin10{};if($Script:LegacyWin10count -ne '0'){$Props."Legacy Win10" = ("$Script:LegacyWin10count")} else { $script:zerovals.Add('Legacy Win10') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineLegacyWin10 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipLegacyWin10 is set to $SkipLegacyWin10.  Skipping DeclineLegacyWin10 Function."
		    $LGWin10 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineLegacyOff365{};if($Script:LegacyOff365count -ne '0'){$Props."Legacy O365" = ("$Script:LegacyOff365count")} else { $script:zerovals.Add('Legacy O365') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineLegacyOff365 function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipLegacyOff365 is set to $SkipLegacyOff365.  Skipping DeclineLegacyOff365 Function."
		    $LGOff365 = "Skipped"
	    ...
	    {	
		    Try{
			    DeclineWin10FeatureUpdates{};if($Script:FeaureWin10UpdatesCount -ne '0'){$Props."Win10 Servicing Updates" = ("$Script:FeaureWin10UpdatesCount")} else { $script:zerovals.Add('Win10 Servicing Updates') > $null }
		    }
		    Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run DeclineWin10FeatureUpdates function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	    }
	    Else
	    { 
		    Write-ToLog "SkipWin10FeatureUpdates is set to $SkipWin10FeatureUpdates.  Skipping  DeclineWin10FeatureUpdates Function."
		    $Win10FUP = "Skipped"
	...
	Try{WSUSCleanupCompressUpdates{};$Props."Cleanup Compress Updates" = ($script:Compupdates)}
	...
	Try{WSUSCleanupCleanupObsComputers{};$Props."Cleanup Obsolete Computers" = ($script:CleanObsComp)}
	Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run WSUSServerCleanup function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	Try{WSUSCleanupUneededContentFiles{};$Props."Clean Uneeded Content Files" = ($script:CleanContents)}
	Catch{Write-EventLog -LogName $Eventlog -EventID 21021 -Message "Unable to run WSUSServerCleanup function on $script:WsusServer" -Source $EventSource -EntryType Error; SendMail{}}
	...
	Write-ToLog ""
                If($script:OneOff)
                {
                    Write-ToLog "List of One-Offs being declined:"
                    Foreach($upd in $script:OneOff){
                        $updv = "    " + $upd.title + " " + "UpdateID: " + $upd.ID.UpdateID.GUID
                        Write-ToLog $updv
